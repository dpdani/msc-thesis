...
This Chapter begins by recalling hash tables and their many applications in computing, and then delves into the relevance of concurrent hash tables.
...
\section[Hash tables, concurrent hash tables, and their applications]{Hash tables, concurrent hash tables, and\\their applications}\label{sec:hash-tables}
