...
That is, most lookups return that the key searched for was not found in the hash table.
...
Mutual exclusion should be used when it helps to simplify the algorithm and its running time.
...
See~\S\ref{subsec:qsbr} for a discussion on QSBR\@.
