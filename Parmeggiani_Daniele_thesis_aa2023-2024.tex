...
\usepackage[backend=biber, dateabbrev=false, urldate=comp, giveninits=true]{biblatex}
...
\usepackage{amssymb}
\DTMsavedate{publish day}{2024-10-04}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
    ...
    \input{chapters/02-free-threading}
    \input{chapters/03-review}
    \input{chapters/04-design}
    \input{chapters/05-implementation}
    \input{chapters/06-measurements}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \appendix
    \input{chapters/99-01-atomic-reference}
    \input{chapters/99-02-atomic-integer}
    \input{chapters/99-03-language-summit-2024}
