...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
    ...
    \input{chapters/02-review.tex}
    \input{chapters/03-design-implementation.tex}
    \input{chapters/04-measurements.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \appendix
    \input{chapters/99-01-atomic-reference.tex}
    \input{chapters/99-02-atomic-integer.tex}
